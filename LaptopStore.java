...
public class LaptopStore {
    ...
    public void generateLaptops(int count) {
        String[] models = {"Dell", "HP", "Lenovo", "Asus", "Acer", "Huawei", "Apple"};
        int[] ramOptions = {4, 8, 16, 32, 64};
        int[] hddOptions = {256, 512, 1024, 2048};
        String[] osOptions = {"Windows", "Linux", "Mac OS"};
        String[] colorOptions = {"Black", "Silver", "White", "Blue", "Red", "Green"};
        ...
        for (int i = 0; i < count; i++) {
            ...
            double price = 500 + random.nextDouble() * 4500; // Цена от 500 до 5000
